...
gapminder_1997 <- read_csv("1_introR/data/gapminder_1997.csv")
```
...
read_csv(file = '1_introR/data/gapminder_1997.csv')
```
...
>  read_csv(file = '1_introR/data/gapminder_1997.csv') # reads in csv file
> ```
{: .callout}
