...
<img src="images/r-plotting/initial_rstudio.png" width="700"/>
...
TODO: explain double-colon syntax
...
metadata[2, 'ptID']
metadata[1:4,]
metadata[1:4, c('ptID', 'condition')]
```


TODO: force an error to teach warnings/messages/errors