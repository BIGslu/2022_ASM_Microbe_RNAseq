...
Or a histogram
```{r}
p <- ggplot(modelDat, aes(x=E, fill = condition)) + 
  geom_histogram() +
  xlab("Gene Expression Level")
p
```

We don't have a ton of data here so these plots look a little weird and we get a message about the histogram, but this could be useful if you have more data.
